...
return [
    ...
    'title' => 'ForgeKin API Documentation',

    'description' => 'ForgeKin connects employers with freelancers. This API powers freelancer registration, employer onboarding, job posting, and admin management.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtain a token by calling one of the login endpoints (freelancer, employer, or admin). Then include it as `Authorization: Bearer {token}` in your requests.',
    ],
    ...
    'groups' => [
        ...
        // Note: does not work for `external` docs types
        'order' => [
            'Freelancer Registration & Verification',
